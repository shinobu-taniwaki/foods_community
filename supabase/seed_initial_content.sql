...
BEGIN
  ...
  SELECT admin_id, 'column',
    ...
    'ログイン画面の「パスワードをお忘れの方」を押してください。' || E'\n\n'
    || '登録したメールアドレスを入力すると、パスワードを設定し直すためのリンクがメールで届きます。リンクを押して、新しいパスワードを設定できます。' || E'\n\n'
    || 'すぐにログインしたいときは「パスワードなしでログイン（メールでリンクを受け取る）」も使えます。メールが届かない場合は、迷惑メールフォルダもご確認ください。',
    false, 'published', now()
  WHERE NOT EXISTS (
